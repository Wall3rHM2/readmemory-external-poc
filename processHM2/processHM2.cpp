...
int getModule(wchar_t moduleName[], HMODULE modules[1024], HANDLE process, HMODULE* mainModule)
{
    for (int i = 0; i < sizeof(modules) / sizeof(HMODULE) + 128; i++) { //searches for main module inside all modules array
